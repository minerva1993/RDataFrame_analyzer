...
def histos(ch, step, syst_name):
  ...
  d['njet_jerc'] = ROOT.RDF.TH1DModel('h_NJet_Ch{}_S{}{}'.format(ch, step, syst_name), ';;Entries', 12, 0, 12)
  d['nbjet_jerc'] = ROOT.RDF.TH1DModel('h_NBJetCSVv2M_Ch{}_S{}{}'.format(ch, step, syst_name), ';;Entries', 6, 0, 6)
